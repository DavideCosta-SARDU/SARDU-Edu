...
export default defineMessages({
    browserNotRecommended: {
        defaultMessage: 'We are very sorry, but it looks like you are using a browser version that SARDU-Block ' +
        ...
        id: 'sarduBlock.gui.unsupportedBrowser.notRecommended'
    },
    browserUnsupported: {
        defaultMessage: 'We are very sorry, but SARDU-Block does not support this browser. We recommend updating ' +
        ...
        id: 'sarduBlock.gui.unsupportedBrowser.description'
    },
    crash: {
        defaultMessage: 'We are sorry, but it looks like SARDU-Block has crashed. Please refresh the page to try again.',
        description: 'Message to inform the user that the page has crashed',
        id: 'sarduBlock.gui.crashMessage.description'
    },
    lostPeripheralConnection: {
        defaultMessage: 'SARDU-Block lost connection to {extensionName}.',
        description: 'Message indicating that an extension peripheral has been disconnected',
        id: 'sarduBlock.gui.alerts.lostPeripheralConnection'
    },
    webGlRequired: {
        defaultMessage: 'Unfortunately it looks like your browser or computer <a>{webGlLink}</a>. This ' +
            'technology is needed for SARDU-Block to run.',
        description: 'WebGL missing message',
        id: 'sarduBlock.gui.webglModal.description'
    }
});
