...
const HardwareButtons = ({hasHardwareSelection, onBoardClick, onComponentClick, onRobotClick}) => {
    const intl = useIntl();
...
HardwareButtons.propTypes = {
    hasHardwareSelection: PropTypes.bool.isRequired,
